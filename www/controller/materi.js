                                            ...
                                            datalist += '<ul class="product-sec animated fadein">';
                                                ...
                                                for (var subkey in submenu) {
                                                    if (submenu.hasOwnProperty(subkey)) {
                                                        datalist += '<li style="padding:10px;border-bottom:solid #ddd 1px"><a onclick="javascript:fade(\'materi-kelas.html?action=read&chatid='+ dl[key]["id"]+'&materi=' + submenu[subkey]["subid"] + '&userid=' + localStorage.userid + '\')">'+ submenu[subkey]["tglsub"] + ' <i class="fal fa-arrow-right right"></i></a></li>';
                                                    }
                                                }
                                            datalist += '</ul>';
                                        datalist += '</div>';
