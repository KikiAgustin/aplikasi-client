						...
						$("#sec").html(data['sub']);
							...
							if(jml>0) {
								...
								if (dl.hasOwnProperty(key)) {
								  ...
								  datalist += `
								  <div class="blog-depan-card animated fadein delay-1 waves-effect" onclick="fade('funworld-read.html?action=read&id=${dl[key]["id"]}')" style="height:auto">
								  	<div class="blog-depan-image"  style="height:auto">
										<a onclick="javascript:fade('funworld-read.html?action=read&id=${dl[key]["id"]}')"><img src="${dl[key]["gambar"]}" alt="" style="margin:15px 10px 15px 10px; width:90%; height:auto" /></a>
									</div>
								  	<div class="blog-depan-preview p-10" style="height:auto">
										<strong><a onclick="javascript:fade('funworld-read.html?action=read&id=${dl[key]["id"]}')">${dl[key]["nama"]}</a></strong>
										<br>${dl[key]["ringkas"]}<br><br>${dl[key]["km"]}
									</div>
								  </div>
								  `;
