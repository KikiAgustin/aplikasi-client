            ...
            if (data['status'] == "OK") {
                ...
                if (data['mitraid'] > "0") {
                    if (data['mitraid_until'] >= dt) {
                        ...
                        datalist += '</div>';
                        datalist += '<a onclick="javascript:fade(\'school.html\')" class="waves-effect waves-light btn-large accent-color width-100 m-b-20 animated bouncein delay-4 button button-block button-positive">Claim Voucher</a>';
                    } else {
                        datalist += '<div class="padding" style="margin:20px 0px 20px 0px;">';
