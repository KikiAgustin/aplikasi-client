	...
	$.ajax({
		...
		success: function (data) {
			...
			if (data['status'] == "OK") {
				...
				// datalist += '<div class="konsulsec">';
				// datalist += '<a onClick="javascript:fade(\'funcommunity-read.html?id=' + id + '\');"  class="active" style="border-bottom:none">Profile</a>';
				// datalist += '<a onClick="javascript:fade(\'belivoucher.html?id=' + id + '\');"  class="active" style="border-bottom:none">Transaksi</a>';
				// datalist += '<a onClick="javascript:fade(\'belivoucher.html?id=' + id + '\');"  class="active" style="border-bottom:none">Lokasi</a>';
				// datalist += '<a onClick="javascript:fade(\'belivoucher.html?id=' + id + '\');"  class="active" style="border-bottom:none">Group</a>';
				// datalist += '</div>';
				datalist += '<div class="tabs"><div class="tab tab-active" onClick="javascript:fade(\'funcommunity-read.html?id=' + id + '\');">Profile</div>';
				datalist += '<div class="tab" onClick="javascript:fade(\'belivoucher.html?id=' + id + '\');">' + data["judul_read"] + '</div>';
				datalist += '<div class="tab" onClick="javascript:fade(\'lokasiComunity.html?id=' + id + '\');">Lokasi</div>';
				datalist += '<div class="tab" onClick="javascript:fade(\'group_comunity.html?action=read&chatid=' + data["group_id"] + '&userid=' + localStorage.userid + '\');">Group</div>';
				datalist += '</div>';
