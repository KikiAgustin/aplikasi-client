...
function HitungText(){
	...
	if( jumlahtext > 1){
		...
		$.ajax({
			type: "POST",
			url: "https://www.dfunstation.com/api4/android/index.php/member/tesmengetik/?callback=?",
			data: dataString,
			crossDomain: true,
			cache: false,
			success: function(data) 
			...
			success: function(data) {
				...
				if(data.text) {
					...
					for (var i = 0; i < data.text.length; i++) {
						...
						var audio = new Audio('http://serverdevelopment2020.my.id/uploads/notify.mp3');
						audio.play();
